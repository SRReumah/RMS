...
-- =============================================
-- STORED PROCEDURE: Get daily sales report
-- =============================================
DELIMITER //
...
BEGIN
    ...
    LEFT JOIN customer c ON o.customer_id = c.customer_id
    WHERE DATE(p.payment_date) = report_date
...
-- SELECT payment_mode, SUM(amount) as total_sales, COUNT(*) as transaction_count 
-- FROM payment WHERE status = 'Completed' GROUP BY payment_mode;

-- Get top selling items
-- SELECT m.item_name, SUM(oi.quantity) as total_quantity, SUM(oi.subtotal) as total_revenue
-- FROM order_items oi
